...
notesRoutes.post('/notes/:user_id', noteController.createNote)
...
notesRoutes.get('/showall', noteController.showAllNotes)



notesRoutes.delete('/delete/:id', noteController.deleteNote)
